...
export const getFontStyleControlButtonClassName = (
  ...
  return `inline-flex h-7 w-6 items-center justify-center text-sm font-normal sm:w-7 ${stateClassName} ${FONT_STYLE_CONTROL_HOVER_CLASS_NAME} focus:outline-none focus-visible:bg-[#242526] focus-visible:text-[#D4D4D4]`;
};
